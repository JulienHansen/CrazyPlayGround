...
from .crazyplayground_marl_env_cfg import CrazyplaygroundMarlEnvCfg


class CrazyplaygroundMarlEnv(DirectMARLEnv):
    cfg: CrazyplaygroundMarlEnvCfg

    def __init__(self, cfg: CrazyplaygroundMarlEnvCfg, render_mode: str | None = None, **kwargs):
