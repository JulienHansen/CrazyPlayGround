...
BASE = {
    ...
    # publish the ground-truth body parameters in the "critic" observation group.
    # PPO here is symmetric and ignores them, but recording them keeps these runs
    # reproducible for later work that conditions a critic on privileged state.
